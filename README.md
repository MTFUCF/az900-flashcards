...
- Switch between all-card review, missed-only review, and a 50-question mock exam
- Switch between 10, 20, and 50 question sessions depending on how much exam-style drilling you want
- Finish a test session with an immediate score summary and per-domain breakdown
...
The deck intentionally goes broader than the initial fundamentals set so you can use the same app for short daily review, missed-question cleanup, and longer mock-exam sessions.
